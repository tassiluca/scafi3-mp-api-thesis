...
\begin{adjustwidth}{-0.5cm}{-1.5cm} % reduce left and right margins by 1cm
\begin{minipage}{0.70\textwidth} % left column: code
    \lstinputlisting[
        language=Scala, 
