...
\todo{replace branch with if then else}
...
%
The \texttt{alchemist-incarnation} module, instead, depends on the Alchemist simulator and the JVM platform, thus being limited to JVM-based platforms only.
