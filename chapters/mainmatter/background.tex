...
%
In this context, the term \textit{platform} denotes the combination of hardware architecture and operating system, whereas \textit{environment} represents the broader collection of external elements with which the software interacts, including execution runtimes and system interfaces.
%
