...
%
Compilation proceeds through a pipeline of stages, shown in \todo{ref figure}, performed after the Scala frontend compiler (responsible for parsing and type-checking it):
